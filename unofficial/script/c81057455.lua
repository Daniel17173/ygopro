...
function c81057455.target1(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.IsExistingTarget(c81057455.filter,tp,LOCATION_MZONE,0,1,nil)
		and e:GetHandler():GetFlagEffect(81057455)==0
		and Duel.SelectYesNo(tp,aux.Stringid(81057455,0)) then
		e:SetCategory(CATEGORY_POSITION)
		e:SetProperty(EFFECT_FLAG_CARD_TARGET)
		local g=Duel.SelectTarget(tp,c81057455.filter,tp,LOCATION_MZONE,0,1,1,nil)
...
function c81057455.target2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c81057455.filter,tp,LOCATION_MZONE,0,1,nil)
...
function c81057455.limcon(e,tp,eg,ep,ev,re,r,rp)
