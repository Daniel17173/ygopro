...
function c5708.initial_effect(c)
	...
	e2:SetCountLimit(1,57082)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetCondition(c5708.cdspsum)
	e2:SetTarget(c5708.tgspsum)
	e2:SetOperation(c5708.opspsum)
	c:RegisterEffect(e2)
end
c5708.xyz_number=37
...
function c5708.opspsum(e,tp,eg,ep,ev,re,r,rp)
