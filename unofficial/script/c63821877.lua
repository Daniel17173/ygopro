...
function c63821877.initial_effect(c)
	...
	e2:SetCountLimit(1,638218772)
	e2:SetCost(c63821877.tdcost)
	e2:SetTarget(c63821877.tdtg)
	e2:SetOperation(c63821877.tdop)
	c:RegisterEffect(e2)
end
...
function c63821877.tdcost(e,tp,eg,ep,ev,re,r,rp,chk)
