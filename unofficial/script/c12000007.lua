...
function c12000007.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(12000007,0))
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_FLIP)
	e1:SetCountLimit(1)
	e1:SetTarget(c12000007.target)
	e1:SetOperation(c12000007.operation)
	c:RegisterEffect(e1)
...
function c12000007.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		...
		c:RegisterFlagEffect(12000007,RESET_EVENT+0x1fe0000,0,1)
	end
end
