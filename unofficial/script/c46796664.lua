...
function c46796664.initial_effect(c)
	...
	e2:SetCondition(c46796664.splimcon)
	...
	e2:SetRange(LOCATION_PZONE)
	e2:SetCountLimit(1)
	e2:SetCondition(c46796664.damcon1)
	e2:SetOperation(c46796664.ctop)
	c:RegisterEffect(e2)
	--send to grave
	...
	e3:SetTarget(c46796664.target)
	e3:SetOperation(c46796664.operation)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
	e4:SetCode(EVENT_SPSUMMON_SUCCESS)
	c:RegisterEffect(e4)
end
function c46796664.splimcon(e)
...
function c46796664.damcon1(e,tp,eg,ep,ev,re,r,rp)
...
function c46796664.ctop(e,tp,eg,ep,ev,re,r,rp)
	...
	local c=e:GetHandler()
		...
		e1:SetLabel(cid)
		e1:SetValue(c46796664.damval)
		e1:SetReset(RESET_CHAIN)
		Duel.RegisterEffect(e1,tp)
	Duel.Destroy(c,REASON_EFFECT)
end
function c46796664.damval(e,re,val,r,rp,rc)
