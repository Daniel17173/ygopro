...
function c6845.val(e,c)
	return Duel.GetMatchingGroupCount(c6845.filter,c:GetControler(),0,LOCATION_GRAVE+LOCATION_MZONE,nil)*1000
end
...
function c6845.aclimit(e,re,tp)
