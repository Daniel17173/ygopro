...
function c5503.initial_effect(c)
	...
	e1:SetTarget(c5503.target)
	e1:SetOperation(c5503.operation)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
...
function c5503.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsFaceup() and c:IsRelateToEffect(e) and tc:IsRelateToEffect(e) then
		c:SetCardTarget(tc)
		tc:RegisterFlagEffect(5503,RESET_EVENT+0x1fe0000,0,0)
	end
end
function c5503.incon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFirstCardTarget()~=nil
end
function c5503.indtg(e,c)
	return e:GetHandler():IsHasCardTarget(c) and c:GetFlagEffect(5503)~=0
end