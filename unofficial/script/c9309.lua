...
function c9309.initial_effect(c)
	...
	e2:SetCondition(c9309.descon)
	e2:SetOperation(c9309.desop)
	c:RegisterEffect(e2)
	...
	e3:SetCountLimit(1,9309)
	e3:SetCost(c9309.tdcost)
	e3:SetTarget(c9309.tdtg)
	e3:SetOperation(c9309.tdop)
	c:RegisterEffect(e3)
end
...
function c9309.descon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsStatus(STATUS_DESTROY_CONFIRMED) then return false end
	local tc=c:GetFirstCardTarget()
	return tc and eg:IsContains(tc)
end
function c9309.desop(e,tp,eg,ep,ev,re,r,rp)
