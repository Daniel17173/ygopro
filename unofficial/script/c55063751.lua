...
function c55063751.spcon(e,c)
	...
	return Duel.GetLocationCount(1-tp,LOCATION_MZONE)>-1
		...
		and not Duel.IsExistingMatchingCard(c55063751.spfilter,c:GetControler(),0,LOCATION_MZONE,1,nil)
end
...
function c55063751.spcon2(e,c)
	...
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>0 and
		Duel.IsExistingMatchingCard(c55063751.spfilter,c:GetControler(),0,LOCATION_MZONE,1,nil)
end

function c55063751.filter(c,e,tp)
