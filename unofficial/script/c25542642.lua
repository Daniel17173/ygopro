...
function c25542642.initial_effect(c)
	...
	e2:SetCondition(c25542642.descon)
	e2:SetOperation(c25542642.desop)
	c:RegisterEffect(e2)
	...
	e3:SetCountLimit(1,25542642)
	e3:SetCost(c25542642.tdcost)
	e3:SetTarget(c25542642.tdtg)
	e3:SetOperation(c25542642.tdop)
	c:RegisterEffect(e3)
end
...
function c25542642.tdcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c25542642.tdtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c25542642.tgfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local sg=Duel.SelectTarget(tp,c25542642.tgfilter,tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,sg,1,0,0)
end
function c25542642.tdop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local tc=Duel.GetFirstTarget()
