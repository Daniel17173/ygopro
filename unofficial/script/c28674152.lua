...
function c28674152.spcon(e,c)
	...
	return Duel.GetLocationCount(1-tp,LOCATION_MZONE)>-1
		...
		and not Duel.IsExistingMatchingCard(c28674152.spfilter,c:GetControler(),0,LOCATION_MZONE,1,nil)
end
...
function c28674152.tkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsPlayerCanSpecialSummonMonster(tp,28674153,0,0x4011,2800,0,3,RACE_FIEND,ATTRIBUTE_DARK) then
