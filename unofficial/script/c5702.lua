...
function c5702.spfilter(c,e,tp)
	return (c:IsSetCard(0x1e4) or c:IsCode(91152256) or c:IsCode(52077741)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c5702.drfilter(c)
	return c:IsFaceup() and (c:IsSetCard(0x1e4) or c:IsCode(91152256) or c:IsCode(52077741))
end
