...
function c5871.initial_effect(c)
	...
	e1:SetOperation(c5871.activate)
	c:RegisterEffect(e1)
end
function c5871.xfilter(c,tp)
...
function c5871.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return eg:IsExists(c5871.xfilter,1,nil,tp) and Duel.IsExistingTarget(Duel.IsDestructable,tp,0,LOCATION_ONFIELD,1,nil) end
...
function c5871.activate(e,tp,eg,ep,ev,re,r,rp)
