...
function c6723.initial_effect(c)
	...
	e1:SetOperation(c6723.activate)
	c:RegisterEffect(e1)
	--to hand
...
function c6723.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.DiscardHand(tp,c6723.cfilter,1,1,REASON_COST,nil)
end
...
function c6723.activate(e,tp,eg,ep,ev,re,r,rp)
...
function c6723.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c6723.thfilter,tp,LOCATION_DECK,0,3,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c6723.thop(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(c6723.thfilter,tp,LOCATION_DECK,0,nil)
