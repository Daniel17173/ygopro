...
--Terminal World Next
--Script by nekrozar
function c100911067.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetCondition(c100911067.condition)
	c:RegisterEffect(e1)
	--
	...
	e4:SetValue(c100911067.aclimit)
	c:RegisterEffect(e4)
	...
	e5:SetTarget(c100911067.setlimit)
	c:RegisterEffect(e5)
end
function c100911067.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c100911067.svalue(e,fp,rp,r)
	local ct=3
	for i=5,7 do
...
function c100911067.aclimit(e,re,tp)
...
function c100911067.setlimit(e,c,tp)
