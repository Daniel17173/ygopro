...
function c100206021.xyzcon(e,c,og)
...
function c100206021.xyzop(e,tp,eg,ep,ev,re,r,rp,c,og)
	local g=nil
	...
	if og then
		...
		local mg=Duel.GetMatchingGroup(c100206021.mfilter,tp,LOCATION_MZONE,0,nil)
...
function c100206021.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetAttacker():IsControler(1-tp) and not Duel.IsExistingMatchingCard(c100206021.filter,tp,LOCATION_ONFIELD+LOCATION_HAND,0,1,nil)
end
