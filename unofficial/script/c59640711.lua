...
function c59640711.initial_effect(c)
	...
	e2:SetCountLimit(1,59640711)
	e2:SetCost(c59640711.descost)
	e2:SetTarget(c59640711.sptg)
	e2:SetOperation(c59640711.spop)
	c:RegisterEffect(e2)
end
function c59640711.descost(e,tp,eg,ep,ev,re,r,rp,chk)
