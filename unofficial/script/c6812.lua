...
function c6812.initial_effect(c)
	...
	e1:SetCondition(c6812.condition)
	e1:SetTarget(c6812.target)
	e1:SetOperation(c6812.operation)
	c:RegisterEffect(e1)
end
...
function c6812.filter(c,e,tp)
	return c:IsSetCardd(0x9b) and c:GetCode()~=6812 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
